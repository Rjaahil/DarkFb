                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            ...
                            if zedd == '6':
                                os.system('rm -rf login.txt')
				os.system('xdg-open https://m.facebook.com/Romantic.Hack3r')
                                keluar()
                            else:
                                if zedd == '0':
                                    keluar()
